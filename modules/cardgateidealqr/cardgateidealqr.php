...
class Cardgateidealqr extends CardgatePayment {
    ...
    public function __construct() {
        ...
        $this->displayName = $this->l('CardGate iDEAL QR');
        $this->description = $this->l('Accepts payments with CardGate iDEAL QR.');
