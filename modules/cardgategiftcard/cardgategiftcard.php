...
class Cardgategiftcard extends CardgatePayment {
    ...
    public function __construct() {
        ...
        $this->name = 'cardgategiftcard';
        $this->paymentcode = 'giftcard';
        $this->paymentname = 'Gift Card';
        $this->logoname = 'giftcard';
        ...
        $this->displayName = $this->l('CardGate Gift Card');
        $this->description = $this->l('Accepts payments with CardGate Gift Card.');
