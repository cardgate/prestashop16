...
class Cardgatemc extends CardgatePayment {
    ...
    public function __construct() {
        ...
        $this->displayName = $this->l('CardGate MisterCash');
        $this->description = $this->l('Accepts payments with CardGate MisterCash.');
